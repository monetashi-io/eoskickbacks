...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__17038 = cljs.core.instance_QMARK_;
var expr__17039 = reactive_val;
if(cljs.core.truth_((pred__17038.cljs$core$IFn$_invoke$arity$2 ? pred__17038.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__17039) : pred__17038.call(null,reagent.ratom.RAtom,expr__17039)))){
return "ra";
} else {
if(cljs.core.truth_((pred__17038.cljs$core$IFn$_invoke$arity$2 ? pred__17038.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__17039) : pred__17038.call(null,reagent.ratom.RCursor,expr__17039)))){
return "rc";
} else {
if(cljs.core.truth_((pred__17038.cljs$core$IFn$_invoke$arity$2 ? pred__17038.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__17039) : pred__17038.call(null,reagent.ratom.Reaction,expr__17039)))){
return "rx";
} else {
if(cljs.core.truth_((pred__17038.cljs$core$IFn$_invoke$arity$2 ? pred__17038.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__17039) : pred__17038.call(null,reagent.ratom.Track,expr__17039)))){
return "tr";
} else {
return "other";
}
